...
More details of the code can be found in the covXtreme user guide document see the [covXtreme_UserGuide.pdf](https://github.com/sede-open/covXtreme/blob/covXtreme_UserGuide.pdf) in the main repository folder.
